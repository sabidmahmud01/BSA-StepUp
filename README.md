...
A local prototype for the Bangladesh Student Association walking challenge around Texas State University and San Marcos, Texas.

Open `index.html` in a browser to try the app. The prototype includes:

- Host and participant interfaces
- Today's track generator from the Quad
...
- 5, 6, and 7 mile distance options
...
The normal app opens directly to the participant interface. The host dashboard is hidden from regular users; open `index.html?host=1` to access host mode during this prototype phase.
